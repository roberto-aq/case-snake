...
export const DesignPreview = ({ configuration }: Props) => {
	...
	if (material === 'polycarbonate')
		totalPrice += productPrices.material.polycarbonate;
	if (finish === 'textured')
		totalPrice += productPrices.finish.textured;
							...
							<div className='flow-root text-sm'>
								...
								{finish === 'textured' ? (
									<div className='flex items-center justify-between py-1 mt-2'>
										...
										<p className='font-medium text-gray-900'>
											{formatPrice(
												productPrices.finish.textured / 100
											)}
										</p>
									</div>
								) : null}
								...
								{material === 'polycarbonate' ? (
									<div className='flex items-center justify-between py-1 mt-2'>
										...
										<p className='font-medium text-gray-900'>
											{formatPrice(
												productPrices.material.polycarbonate / 100
											)}
										</p>
									</div>
								) : null}
